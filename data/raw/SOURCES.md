...
This project mixes three kinds of raw inputs:
...
- `data/raw/solar/TTS_LBNL_public_file_29-Sep-2025_all.csv`
  Source: Berkeley Lab Tracking the Sun public data zip.
  Public page: https://emp.lbl.gov/tracking-the-sun/
  Scripted download: Google Drive file linked from the Berkeley Lab page.

- `data/raw/interconnection/PGE_Interconnected_Project_Sites_2025-01-31.csv`
- `data/raw/interconnection/SCE_Interconnected_Project_Sites_2025-01-31.csv`
- `data/raw/interconnection/SDGE_Interconnected_Project_Sites_2025-01-31.csv`
  Source: CaliforniaDGStats monthly interconnection archive.
  Public page: https://www.californiadgstats.ca.gov/downloads/
  Scripted download: `Interconnected_Project_Sites_2025-01-31.zip`, then extract the three utility CSVs.
...
- `data/raw/boundaries/tl_2024_us_zcta520/*`
...
These links are useful for reconstructing those families of data, but they should not yet be treated as the exact historical files used in the current repo state.
